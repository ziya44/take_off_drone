...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(pkg_resources.resource_filename('drones', 'assets/'+self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(pkg_resources.resource_filename('drones', 'assets/'+self.URDF)).getroot()
