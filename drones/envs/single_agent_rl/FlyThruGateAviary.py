...
from drones.envs.single_agent_rl.BaseSingleAgentAviary import ActionType, ObservationType, BaseSingleAgentAviary
...
class FlyThruGateAviary(BaseSingleAgentAviary):
    ...
    def _addObstacles(self):
        ...
        """
        super()._addObstacles()
        p.loadURDF(pkg_resources.resource_filename('drones', 'assets/architrave.urdf'),
                   [0, -1, .55],
