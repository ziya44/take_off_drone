...
from drones.utils.utils import sync, str2bool
from drones.utils.enums import DroneModel, Physics
from drones.envs.CtrlAviary import CtrlAviary
...
DEFAULT_TRACE_FILE = pkg_resources.resource_filename('drones', 'assets/example_trace.pkl')
